...
resource resourceは複数形を基本にする
/stores 店舗を一覧形で
/stores/{storeCode} 店舗コードに該当する店舗を一件
/stores/{storeCode}/sales 店舗コードに該当する店舗の売上を一覧で
/stores/{storeCode}/sales/{stripNo} 店舗コードに該当する店舗の売上を伝票番号をキーで
