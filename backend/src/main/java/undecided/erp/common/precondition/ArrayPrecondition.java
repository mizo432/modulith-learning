...
public class ArrayPrecondition {
   ...
   *
   * <p>配列が空の場合、IllegalArgumentExceptionの種類の例外がスローされます。
   *
   * @param array 検証される配列
   * @param <T> 配列要素の型
   * @return 非空の場合は同じ配列
   ...
   */
  public static <T> T[] checkNotEmpty(
   ...
   */
  public static <E> E[] checkAllElementNotNull(
      E[] array, @NonNull Function<Integer, ? extends IndexedRuntimeException> function) {
    if (array == null) {
      return array;
    }
   ...
   *
   * <p>すべての要素がnullの場合、 supplierによって提供されたランタイム例外が発生します。
   *
   * @param <E> 配列内の要素の型
   * @param array 確認する配列
   ...
   */
  public static <E> E[] checkAnyElementNotNull(
      E[] array, @NonNull Supplier<? extends RuntimeException> supplier) {
    if (array == null) {
      return array;
    }
   ...
   */
  public static <E> E[] checkOneElementNotNull(
      E[] array, @NonNull Supplier<? extends RuntimeException> supplier) {
    if (array == null) {
      return array;
    }
   ...
   */
  public static <O, E extends RuntimeException> O[] checkLength(
      O[] array, @NonNull Supplier<E> exceptionSupplier, int size) {
    if (isNull(array)) {
      return null;
    }
   ...
   */
  public static <ValueType, ExceptionType extends RuntimeException>
      ValueType[] checkLengthGreaterThan(
          ValueType[] array, @NonNull Supplier<ExceptionType> exceptionSupplier, int min) {
    if (isNull(array)) {
      return null;
    }
