...
public class FloatPrecondition {
   ...
   */
  public static Float verifyPositive(Float ref,
   ...
   */
  public static Float verifyPositiveOrZero(Float ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier) {
   ...
   */
  public static Float verifyNegative(Float ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier) {
   ...
   */
  public static Float verifyNegativeOrZero(Float ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier) {
