...
/**
 * ChangeRequestは、変更リクエストに関する情報を保持するクラスです。
 *
 * <p>このクラスは、組織変更リクエストの基本的な属性を表します。これらの属性は、 組織の特定、リクエストのトラッキング、および関連情報の管理に使用されます。
 *
 * <p>主に以下の属性を含みます: - 組織ID - 変更リクエスト番号 - 親組織ID - フルネーム（完全名称）
 */
@AllArgsConstructor
@NoArgsConstructor
@Getter
