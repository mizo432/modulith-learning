 ...
 */
@Getter
public class PrefectureAbolitionDate {

  public static final PrefectureAbolitionDate MAX = new PrefectureAbolitionDate(ApplicableDate.MAX);
  /**
   ...
   */
  private PrefectureAbolitionDate(ApplicableDate value) {
    this.value = value;
  }
   ...
   */
  public static PrefectureAbolitionDate of(LocalDate value) {
    if (value.isAfter(ApplicableDate.MAX_DATE)) {
      throw new IllegalArgumentException("Value cannot be after MAX_DATE");
    }

    return new PrefectureAbolitionDate(ApplicableDate.of(value));
  }
   ...
   */
  public static PrefectureAbolitionDate yesterday() {
    return new PrefectureAbolitionDate(ApplicableDate.yesterday());

  }

  public static PrefectureAbolitionDate now() {
    return new PrefectureAbolitionDate(ApplicableDate.now());
