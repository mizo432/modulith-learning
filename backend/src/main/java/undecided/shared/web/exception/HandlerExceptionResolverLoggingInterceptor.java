...
public class HandlerExceptionResolverLoggingInterceptor
    ...
    /**
     * 指定された例外およびリクエスト・レスポンス情報を基に、HTTPステータスコードに応じたログ出力を行います。
     * <p>
     * ステータスコードが100～199の場合は情報ログ、200～299の場合は成功ログ、
     * 300～399の場合はリダイレクトログ、400～499の場合はクライアントエラーログ、 500以上の場合はサーバーエラーログとして処理されます。
     *
     * @param exception ログに記録する例外オブジェクト
     * @param request   ログのコンテキストとなる HttpServletRequest
     * @param response  ログのコンテキストとなる HttpServletResponse
