...
public class LongPrecondition {
   ...
   */
  public static Long checkPositive(
   ...
   */
  public static Long checkRangeClosed(
      Long ref,
   ...
   */
  public static Long checkRangeOpen(
      Long ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull Long min,
      @NonNull Long max) {
   ...
   */
  public static Long checkRangeClosedOpen(
      Long ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull Long min,
      @NonNull Long max) {
   ...
   */
  public static Long checkRangeOpenClosed(
      Long ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull Long min,
      @NonNull Long max) {
   ...
   */
  public static Long checkAtMost(
      Long ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull Long max) {
    if (isNull(ref)) {
   ...
   */
  public static Long checkLessThan(
      Long ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull Long max) {
    if (isNull(ref)) {
   ...
   */
  public static Long checkGreaterThan(
      Long ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull Long min) {
    if (isNull(ref)) {
