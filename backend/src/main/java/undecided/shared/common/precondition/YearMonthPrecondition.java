...
public class YearMonthPrecondition {
   ...
   */
  public static YearMonth checkRangeClosed(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth min,
   ...
   */
  public static YearMonth checkRangeOpen(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth min,
      @NonNull YearMonth max) {
   ...
   */
  public static YearMonth checkRangeClosedOpen(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth min,
      @NonNull YearMonth max) {
   ...
   */
  public static YearMonth checkRangeOpenClosed(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth min,
      @NonNull YearMonth max) {
   ...
   */
  public static YearMonth checkAtLest(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth min) {
    if (ref == null) {
   ...
   */
  public static YearMonth checkAtMost(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth max) {
    if (ref == null) {
   ...
   */
  public static YearMonth checkLessThan(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth max) {
    if (ref == null) {
   ...
   */
  public static YearMonth checkGreaterThan(
      YearMonth ref,
      @NonNull Supplier<? extends RuntimeException> exceptionSupplier,
      @NonNull YearMonth min) {
    if (ref == null) {
