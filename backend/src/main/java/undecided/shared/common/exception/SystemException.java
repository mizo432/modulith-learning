 ...
 *
 * <p>SystemException クラスには3つのコンストラクタがあり、それぞれ例外コード、表示されるメッセージ、および 例外の根本的な原因を指定できます。code パラメータは
 ...
 *
 * <p>SystemException クラスは、例外に関連付けられた例外コードを返す ExceptionCodeProvider インターフェース の getCode()
 * メソッドをオーバーライドしています。
 */
public class SystemException extends RuntimeException implements ExceptionCodeProvider {
   ...
   * コンストラクタ
   *
   * <p>{@link ExceptionCodeProvider}、表示されるメッセージ、および例外の根本原因を指定できます。
   *
   ...
   * コンストラクタ
   *
   * <p>{@link ExceptionCodeProvider} と表示されるメッセージを指定できます。
   *
   * @param code 例外コード {@link ExceptionCodeProvider}
   * @param message 表示されるメッセージ
   */
   ...
   * コンストラクタ
   *
   * <p>{@link ExceptionCodeProvider} と例外の原因を指定できます。
   *
   * @param code 例外コード {@link ExceptionCodeProvider}
