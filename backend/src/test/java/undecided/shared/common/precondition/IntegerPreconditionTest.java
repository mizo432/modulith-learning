...
class IntegerPreconditionTest {
  ...
  class CheckNonNegativeTest {
    ...
    void shouldThrowExceptionWhenMinValue() {
      ...
      // Act & Assert
      assertThatThrownBy(() -> IntegerPrecondition.checkNonNegative(minValue, EXCEPTION_SUPPLIER))
          .isInstanceOf(RuntimeException.class);
    }
  }
  ...
  class CheckRangeClosedOpenTest {
    ...
    void shouldReturnNullWhenNull() {
      ...
      // Act
      Integer result = IntegerPrecondition.checkRangeClosedOpen(null, EXCEPTION_SUPPLIER, min, max);
