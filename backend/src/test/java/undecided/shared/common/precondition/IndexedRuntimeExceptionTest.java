...
class IndexedRuntimeExceptionTest {
   ...
   * Constructor.
   *
   * <p>Method under test: {@link IndexedRuntimeException#IndexedRuntimeException(Integer,
   * Throwable)}
   */
  @Test
   ...
   * Constructor.
   *
   * <p>Method under test: {@link IndexedRuntimeException#IndexedRuntimeException(String, Integer)}
   */
  @Test
  @DisplayName("Constructor")
  void constructor2() {
    // Arrange and Act
    IndexedRuntimeException actualIndexedRuntimeException =
        new IndexedRuntimeException("An error occurred", 1);

    // Assert
    assertThat(actualIndexedRuntimeException.getLocalizedMessage())
        .isEqualTo("Index:1 An error occurred");
  ...
  void constructor3() {
    ...
    // Act
    IndexedRuntimeException actualIndexedRuntimeException =
        new IndexedRuntimeException("An error occurred", 1, cause);
