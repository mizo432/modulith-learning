...
public class MachiAzaTypeTest {
  ...
  void testValueOfCodeInvalidCode() {
    Assertions.assertThrows(NoSuchElementException.class, () -> MachiAzaType.valueOfCode("Dummy"));
    Assertions.assertThrows(NoSuchElementException.class, () -> MachiAzaType.valueOfCode(""));
  }
